...
public class BMWMotor implements AbstractVoertuig {
    ...
    public BMWMotor(String model, int bouwjaar, Engine engine, String kleur, String nummerplaat, int aantalWielen, String uitvoering, double prijs) {
        this.model = model;
